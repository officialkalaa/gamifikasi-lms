...
(function () {
  ...
  const DOM = {
    ...
    missionCheckboxes: document.querySelectorAll(
      '.gml-mission-checkbox input[type="checkbox"]',
    ),
  ...
  function handleContinueLearning(e) {
    ...
    if (!courseData) {
      showNotification(
        "📚",
        "Belum ada course yang sedang dipelajari. Mulai course pertamamu!",
      );
      return;
    }
  ...
  function handleKeyboardShortcuts(e) {
    ...
    if (e.ctrlKey && e.shiftKey && e.key === "N") {
      ...
      showNotification(
        "🔔",
        "Demo notification triggered by keyboard shortcut!",
      );
    }
  ...
  function showNotification(icon, message, time = "Baru saja") {
    ...
    document
      .getElementById("gml-notification-container")
