<section class="gml-forgot-page" aria-labelledby="gml-forgot-title">
    ...
    <div class="gml-forgot-layout">
        <aside class="gml-forgot-visual gml-reveal" aria-label="Account recovery information">
            <div class="gml-visual-orbit" aria-hidden="true">
                <span class="gml-floating-star gml-floating-star-one"></span>
                <span class="gml-floating-star gml-floating-star-two"></span>
                <span class="gml-floating-star gml-floating-star-three"></span>
            </div>

            <div class="gml-security-illustration" aria-hidden="true">
                <div class="gml-shield-wrap">
                    <svg width="156" height="176" viewBox="0 0 156 176" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M78 8L134 28V72C134 113.5 109.8 151.2 78 166C46.2 151.2 22 113.5 22 72V28L78 8Z" fill="white" fill-opacity="0.82"/>
                        <path d="M78 20L122 35.8V72.4C122 105.6 103.4 136.2 78 150.6C52.6 136.2 34 105.6 34 72.4V35.8L78 20Z" fill="#6C5CE7"/>
                        <rect x="57" y="74" width="42" height="36" rx="10" fill="white"/>
                        <path d="M66 74V63C66 56.4 71.4 51 78 51C84.6 51 90 56.4 90 63V74" stroke="white" stroke-width="8" stroke-linecap="round"/>
                        <circle cx="78" cy="92" r="5" fill="#F59E0B"/>
                    </svg>
                </div>

                <div class="gml-floating-card gml-email-card">
                    <span class="gml-card-icon" aria-hidden="true">
                    ...
                    <span>
                        ...
                        <small>Sent securely to your email</small>
                    </span>
                </div>
                ...
                <div class="gml-floating-card gml-badge-card">
                    <span class="gml-card-icon" aria-hidden="true">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                            <path d="M12 3L14.7 8.5L20.8 9.4L16.4 13.7L17.4 19.8L12 16.9L6.6 19.8L7.6 13.7L3.2 9.4L9.3 8.5L12 3Z" fill="currentColor"/>
                        </svg>
                    </span>
                    <span>
                        <strong>Progress protected</strong>
                        <small>Your learning streak stays safe</small>
                    </span>
                </div>
            </div>

            <div class="gml-visual-copy">
                <p class="gml-kicker">Secure Recovery</p>
                <h2>Get back to your learning journey.</h2>
                <p>Enter your email and we will send a safe reset link so you can continue courses, quests, and achievements without stress.</p>
            </div>
        </aside>
